...
- **GLSL LSP — 추가 확장**: Phase 24 / 25 / 26 / 27 가 진단·심볼 테이블·Hover·시맨틱 토큰·Goto/References/Rename 까지 다룸. **Cross-stage rename** (vertex↔fragment 의 같은 uniform 일괄 rename), **함수 오버로드 해석**, **call hierarchy** 등이 잠재 후속. CodeMirror 6 유지(Monaco 전환은 여전히 회피 권장).
